...
class Ui_NewTeam(object):
    ...
    def setupUi(self, NewTeam):
        ...
        NewTeam.setStyleSheet("background-color: rgb(223,246,240);")
    ...
    def retranslateUi(self, NewTeam):
        ...
        self.label.setText(_translate("NewTeam", "Create Team"))
        self.label_2.setText(_translate("NewTeam", "Name :"))
        self.team_name.setText(_translate("NewTeam", ""))
        self.pushButton.setText(_translate("NewTeam", "Add"))
