...
class Ui_evaluate_team(object):
    ...
    def setupUi(self, evaluate_team):
        ...
        evaluate_team.setStyleSheet("background-color: rgb(223,246,240);")
        self.label = QtWidgets.QLabel(evaluate_team)
        self.label.setGeometry(QtCore.QRect(180, 10, 411, 51))
        font = QtGui.QFont()
        ...
        self.points.setStyleSheet("color: rgb(0,0,0);")
    ...
    def retranslateUi(self, evaluate_team):
        ...
        self.label.setText(_translate("evaluate_team", "Evaluate Your Fantasy Team"))
        ...
        self.Evaluate_btn.setText(_translate("evaluate_team", "Evaluate"))
